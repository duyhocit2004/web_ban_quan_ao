<aside class="page-sidebar" data-sidebar-layout="stroke-svg">
    ...
    <div id="sidebar-menu">
      <ul class="sidebar-menu" id="simple-bar">
        ...
        <li class="sidebar-list"> 
          ...
          <ul class="sidebar-submenu"> 
            <li><a href="general-widget.html"> 
                <svg class="svg-menu">
                  <use href="{{asset('./admin/assets/svg/iconly-sprite.svg#right-3')}}"></use>
                </svg>General</a></li>
        ...
        <li class="sidebar-list"> 
            <svg class="pinned-icon" xmlns= " http://www.w3.org/2000/svg" viewBox="0 0 496 512"><!--!Font Awesome Free 6.6.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.--><path d="M248 8C111 8 0 119 0 256s111 248 248 248 248-111 248-248S385 8 248 8zm0 376c-17.7 0-32-14.3-32-32s14.3-32 32-32 32 14.3 32 32-14.3 32-32 32zm0-128c-53 0-96 43-96 96s43 96 96 96c-106 0-192-86-192-192S142 64 248 64c53 0 96 43 96 96s-43 96-96 96zm0-128c-17.7 0-32 14.3-32 32s14.3 32 32 32 32-14.3 32-32-14.3-32-32-32z"/>
            </svg><a class="sidebar-link" href="javascript:void(0)">
            <svg class="stroke-icon" xmlns= " http://www.w3.org/2000/svg" viewBox="0 0 496 512">
              <use href="https://admin.pixelstrap.net/edmin/assets/svg/iconly-sprite.svg#Document"></use>
            </svg><span>Page Layout</span>
            <svg class="feather">
                <!--!Font Awesome Free 6.6.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.--><path d="M248 8C111 8 0 119 0 256s111 248 248 248 248-111 248-248S385 8 248 8zm0 376c-17.7 0-32-14.3-32-32s14.3-32 32-32 32 14.3 32 32-14.3 32-32 32zm0-128c-53 0-96 43-96 96s43 96 96 96c-106 0-192-86-192-192S142 64 248 64c53 0 96 43 96 96s-43 96-96 96zm0-128c-17.7 0-32 14.3-32 32s14.3 32 32 32 32-14.3 32-32-14.3-32-32-32z"/>
            </svg></a>
          <ul class="sidebar-submenu"> 
            <li><a href="box-layout.html">
                <svg class="svg-menu">
                  <use href="http://127.0.0.1:8000/admin/assets/svg/iconly-sprite.svg#right-3"></use>
